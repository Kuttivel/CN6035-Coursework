...
export default class MailService {
  ...
  /* -----------------------------
    ...
    ------------------------------ */
  async sendProductCreationMail(to, sellerName, product) {
  ...
  /* -----------------------------
    ...
    ------------------------------ */
  async sendBuyerPurchaseMail(to, sellerEmail, product, quantity, totalPrice) {
  ...
  /* -----------------------------
    ...
    ------------------------------ */
  async sendSellerPurchaseMail(to, buyerEmail, product, quantity, totalPrice) {
